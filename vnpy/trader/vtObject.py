...
class VtPositionData(VtBaseData):
    ...
    def __init__(self):
        ...
        self.byStrategy = EMPTY_STRING
        self.Longposition = EMPTY_FLOAT 
        self.Shortposition = EMPTY_FLOAT 
        self.LongpositionProfit = EMPTY_FLOAT 
        self.ShortpositionProfit = EMPTY_FLOAT 
        self.Longprice =  EMPTY_FLOAT 
        self.Shortprice =  EMPTY_FLOAT 
        self.Longfrozen = EMPTY_FLOAT 
        self.Shortfrozen = EMPTY_FLOAT 
        self.forceliqu = EMPTY_FLOAT 
        self.create_date = None
        self.leverage = EMPTY_INT
